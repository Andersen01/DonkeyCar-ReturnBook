...
flags.DEFINE_string('trained_checkpoint_prefix','./training/model.ckpt-66',
                    'Path to trained checkpoint, typically of the form '
                    'path/to/model.ckpt')
flags.DEFINE_string('output_directory', './training/frozen_inference_graph_pb', 'Path to write outputs')
